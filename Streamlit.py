...
if mentor_csv_file and founder_csv_file:
    if st.button("Get Results"):
        import tempfile
        # Create temporary files for the uploaded CSVs
        ...
        # Run matching function which returns both result lines and pairs data
...
# If pairs_data exists, show the download button for CSV export
